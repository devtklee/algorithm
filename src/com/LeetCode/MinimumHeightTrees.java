...
public class MinimumHeightTrees {
    ...
    LeetCode Algorithm Question - Minimum Height Trees Solution
    Solved Date : 2020-11-04
    Author : TK Lee
    ...
    he height of a rooted tree is the number of edges on the longest downward path between the root and a leaf.
    ...
    public static List<Integer> findMinHeightTrees(int n, int[][] edges) {
        List<Integer> mht= new LinkedList<>();
